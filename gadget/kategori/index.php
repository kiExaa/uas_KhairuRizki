                                    ...
                                    <td>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-header bg-warning">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Data Detail Merk</h1>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                Yakin <?=$data['nama_kategori']?> Ingin Dihapus?
                                            </div>
                                            <div class="modal-footer">
